    ...
    private void aceptarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButtonActionPerformed
        ...
        if(aux){
            ...
            if(cantAlumnos.isEmpty()){
                JOptionPane.showMessageDialog(null,"El campo 'Cantidad de Alumnos' no puede estar vacio","Mensaje de Error",JOptionPane.ERROR_MESSAGE);
            }else{
                if(this.esporadica.isSelected() && this.jTable1.getRowCount()==0 && this.jTable1.getSelectedRow()==-1){//Tabla vacia
                    JOptionPane.showMessageDialog(null,"Ingrese al menos una fecha para la reserva","Mensaje de Error",JOptionPane.ERROR_MESSAGE);
                }else{
